        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="select2 form-control" aria-required="true" name="users[]" multiple
                    ...
                    <option value="0" id="allOption" @if(@$item->recipients == 0 &&  ! Str::contains(Route::currentRouteName(), 'create')) selected @endif>{{__('cp.all')}}
                    </option>
                    @foreach ($users as $oneUser)

                        <option value="{{ $oneUser->id }}" class="optionEligibleSubjects" @if(in_array($oneUser->id,
