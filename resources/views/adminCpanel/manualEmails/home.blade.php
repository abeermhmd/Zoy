            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.manual_emails'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                <div>
                    ...
                    <a href="{{route('admins.manual_emails.create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{route('admins.manual_emails.index')}}">
                                 <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ url(app()->getLocale() . '/admin/manual_emails') }}" class="btn sbold btn-default btnRest">
                        ...
                        <table class="table table-hover tableWithSearch" id="tableWithSearch">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ ucwords(__('cp.Recipients'))}}</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr-{{ @$one->id }}">
                                    ...
                                    <td class="v-align-middle wd-25p">
                                        ...
                                        {{ @$one->date ?? @$one->date   }} - {{ @$one->time ?? @$one->time->format('h:m a') }}
                                        @else
                                        --
                                        @endif
                                    </td>
                                    <td class="v-align-middle wd-10p"> <span class="badge badge-pill badge-primary">
                                            {{ @$one->recipients == 1 ? __('cp.all') : __('cp.Specific Users') }}</span></td>
                                    ...
                                    <td class="v-align-middle wd-15p">
                                        @if (@$one->status == 'draft')
                                            <a href="{{ route('admins.manual_emails.edit', @$one->id) }}" class="btn btn-sm btn-clean btn-icon"
                                                title="{{ __('cp.edit') }}">
                                                <i class="la la-edit"></i>
                                            </a>
                                        @else
                                            <a href="{{ route('admins.manual_emails.show', @$one->id) }}" class="btn btn-sm btn-clean btn-icon"
                                                title="{{ __('cp.show') }}">
                                                <i class="la la-eye"></i>
                                            </a>
                                        @endif
