            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.permissions'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                <div>
                    ...
                    <a href="{{route('admins.permissions.create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{route('admins.permissions.index')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{ route('admins.permissions.index') }}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                            ...
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-10p">{{@$one->created_at != '' ? @$one->created_at->format('Y-m-d') : '--'}}</td>

                                        <td class="v-align-middle wd-15p optionAddHours">

                                            <a href="{{route('admins.permissions.edit' , @$one->id)}}"
