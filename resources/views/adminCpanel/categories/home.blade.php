        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{route('admins.categories.create')}}" class="btn btn-secondary  mr-2 btn-success">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="multiple2" class="form-control"
                                                    ...
                                                    <option value="man" @selected(request('department') == 'man')>
                                                        {{__('cp.man')}}
                                                    </option>
                                                    <option value="women" @selected(request('department') == 'women')>
                                                        {{__('cp.women')}}
                                                    </option>
                                                </select>
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th> {{ucwords(__('cp.department'))}}</th>
                                    <th> {{ucwords(__('cp.is_featured'))}}</th>
                                    <th> {{ucwords(__('cp.bulk_discount_percentage'))}}</th>
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            ...
                                            <a href="{{route('admins.categories.edit' , @$one->id)}}"
