        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="select2 form-control" name="department" required>
                    ...
                    <option value="women" {{ old('department', @$item->department) == 'women' ? 'selected' : '' }}>{{__('cp.women')}}</option>
                    <option value="man" {{ old('department', @$item->department) == 'man' ? 'selected' : '' }}>{{__('cp.man')}}</option>
                </select>
            </div>
        </div>
       <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="discount" value="{{ old('discount', @$item->discount) }}"
                step="0.01" min="0" />
        </div>
    </div>
        <div class="col-md-6">
