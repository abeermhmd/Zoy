    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div>
                ...
                <a href="{{ route('admins.admins.create') }}" class="btn btn-secondary  mr-2 btn-success">
            ...
            <div class="gutter-b example example-compact">
                ...
                <div class="contentTabel">
                    ...
                    <div class="container box-filter-collapse">
                        <div class="card">
                            <form class="form-horizontal" method="get" action="{{ route('admins.admins.index') }}">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ route('admins.admins.index') }}" type="submit"
                                ...
                                <tr class="odd gradeX" id="tr-{{$one->id}}">
                                    ...
                                    <td class="v-align-middle wd-15p optionAddHours">
                                        ...
                                        <a href="{{url(getLocal().'/admin/admins/'.$one->id.'/edit_password')}}"
                                            class="btn btn-sm btn-clean btn-icon" title="{{__('cp.Change_Password')}}">
                                            <i class="la la-key"></i>
                                        </a>
