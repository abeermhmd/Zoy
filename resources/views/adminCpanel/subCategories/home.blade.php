...
@section('title') {{ucwords(__('cp.subCategories'))}}
@endsection
@section('content')
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.subCategories'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{route('admins.subCategories.index')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="multiple2" class="form-control" name="parent_id">
                                                    <option value="">{{__('cp.all')}}</option>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}" @selected(request('parent_id')==  $category->id)>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">{{__('cp.is_featured')}}</label>
                                                <select id="multiple2" class="form-control" name="is_featured">
                                                    <option value="">{{__('cp.all')}}</option>
                                                    <option value="yes" @selected(request('is_featured')=='yes' )>
                                                        {{__('cp.yes')}}
                                                    </option>
                                                    <option value="no" @selected(request('is_featured')=='no' )>
                                                        {{__('cp.No')}}
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{ route('admins.subCategories.index') }}" type="submit"
