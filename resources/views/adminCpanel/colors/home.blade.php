...
@section('title') {{ucwords(__('cp.variants_management'))}}
@endsection
@section('content')
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{route('admins.colors.create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{route('admins.colors.index')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="hex_code" placeholder="Hex Code"
                                                    value="{{request('hex_code')?request('hex_code'):''}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{ route('admins.colors.index') }}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                            ...
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{@$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-25p">{{ @$one->hex_code }}</td>
                                        ...
                                        <td class="v-align-middle wd-10p">{{\Carbon\Carbon::parse(@$one->created_at)->format('Y-m-d') ?? ''}}</td>

                                        <td class="v-align-middle wd-15p">
                                            <a href="{{route('admins.colors.edit' , @$one->id)}}"
