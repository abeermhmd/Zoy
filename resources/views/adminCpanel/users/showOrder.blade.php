...
@section('companyContent')
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <form enctype="multipart/form-data" class="form-horizontal" role="form" id="form">
                {{ csrf_field() }}
                   ...
                   <div class="row col-sm-12">
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                  value="{{@$order->user->name ? @$order->user->name : @$order->name}}" disabled/>
                        </div>
                    </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                  value="{{@$order->user->email ? @$order->user->email : @$order->email}}" disabled/>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                  value="{{@$order->user->mobile ? @$order->user->mobile : @$order->mobile}}" disabled/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                  value="{{@$order->address->country->name ? @$order->address->country->name : @$order->country->name}}" disabled/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                @if(@$order->address_id != '')
                                    value="{{@$order->address->city_id  ? @$order->address->city->name : @$order->address->city_name}}"
                                @else
                                    value="{{@$order->city_id  ? @$order->city->name : @$order->city_name}}"
                                @endif disabled/>
                        </div>
                    </div>
                       <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control form-control-solid"
                                  @if(@$order->payment_status == '0') value="{{__('cp.not_paid')}}" @else  value="{{__('cp.paid')}}" @endif disabled />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
										...
										<div class="card-body py-2">
											...
											<div class="table-responsive">
												<table class="table table-borderless table-vertical-center">
													<thead>
														<tr>
															<th class="p-0" style="min-width: 95px"> </th>
															<th class="p-0" style="min-width: 95px">{{__('cp.name')}}</th>
															<th class="p-0" style="min-width: 95px">{{__('cp.color')}}</th>
															<th class="p-0" style="min-width: 95px">{{__('cp.size')}}</th>
															<th class="p-0" style="min-width: 95px">{{__('cp.quantity')}}</th>
															<th class="p-0" style="min-width: 100px">{{__('cp.price')}}</th>
															<th class="p-0" style="min-width: 100px">{{__('cp.offer_price')}}</th>
														</tr>
													</thead>
													<tbody>
														...
														<tr>
															...
															<td class="text-right">
																<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{@$one->product->name}}</span>

															</td>
															<td class="text-right">
																<span class="text-dark-75 font-weight-bolder d-block font-size-lg">
																  		  {{@$one->color_id ? $one->color->name : '--'}}   </span>

															</td>
                                                            <td class="text-right">
																<span class="text-dark-75 font-weight-bolder d-block font-size-lg">
																  		 {{@$one->size_id ? $one->size->name : '--'}}  </span>
															...
															<td class="text-right">
																<span class="text-dark-75 font-weight-bolder d-block font-size-lg">
																{{number_format(@$one->price,3)}} 	</span>

															</td>
															<td class="text-right">
																<span class="text-dark-75 font-weight-bolder d-block font-size-lg">
														    @if($one->price_offer != null )	{{number_format(@$one->price_offer,3)}}	 @else -- @endif  </span>
                ...
                <!--<button id="submitButton" class="btn btn-success ">{{__('cp.changeStatus')}}</button>-->
                </div>
                <!--end::Toolbar-->
